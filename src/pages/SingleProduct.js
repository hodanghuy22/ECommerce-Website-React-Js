...
const SingleProduct = () => {
    const props = {
        ...
        height: 500, 
        zoomWidth: 500, 
        img: "https://cdn-amz.woka.io/images/I/81OXGwEgBDL.jpg"
    };
                            ...
                            <div className='main-product-image'>
                                ...
                                <div>
                                    <div className='other-product-images d-flex flex-wrap gap-15 '>
                                        <div>
                                            <img className='img-fluid' src='https://cdn-amz.woka.io/images/I/81OXGwEgBDL.jpg' alt=""/>
                                        </div>
                                        <div>
                                            <img className='img-fluid' src='https://cdn-amz.woka.io/images/I/81OXGwEgBDL.jpg' alt=""/>
                                        </div>
                                ...
                                <div className=' py-3'>
                                    ...
                                    <div className='d-flex gap-10 align-items-center my-3'>
                                        ...
                                        <a href='javascript:void(0);'
                                         onClick={()=>{copyToClipboard("https://cdn-amz.woka.io/images/I/81OXGwEgBDL.jpg")}}>
                                            Coppy Product Link
                                        </a>
                                    </div>
                                </div>
                        ...
                        <div className='col-12'>
                            ...
                            <div className='bg-white p-3'>
                                <p className='bg-white p-3'>
                                    Lorem ipsum dolor, sit amet consectetur odipisicing etit,
                                    jeretur niS'. simit ique it tun aut per teretXits votuptas, qutsquam
                                    obcaecati qui nobis officia. Voluptatlbus in harum deleniti
                                    tabore officia esse •as? Repel tat?
                                </p>
                            </div>
                        </div>
                    </div>
